package com.approve.son.documentapproval.global.system.exception;
...
import com.approve.son.documentapproval.global.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<CommonResponse> handleBadRequestException(BadRequestException e) {
        ...
        if (e.getMessage() == null || e.getMessage().isBlank()) {
            return ResponseEntity.ok().body(CommonResponse.of(e.getErrorCode()));
        }
        return ResponseEntity.ok().body(CommonResponse.of(e.getErrorCode(), e.getMessage()));
    }
